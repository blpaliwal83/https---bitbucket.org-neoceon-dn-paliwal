...
Ext.Loader.addClassPathMappings({
  ...
  "POS": "app",
  "storage.WebSql": "storage/WebSql.js"
});

Ext.ClassManager.addNameAlternateMappings({
  "DNB.controller.Account": [],
  "DNB.controller.AddEvent": [],
  "DNB.controller.AddPromotion": [],
  "DNB.controller.EventDetail": [],
  "DNB.controller.Events": [],
  "DNB.controller.Home": [],
  "DNB.controller.Login": [],
  "DNB.controller.Registeration": [],
  "DNB.controller.ServicesController": [],
  "DNB.controller.Settings": [],
  "DNB.controller.UserEmail": [],
  "DNB.controller.UserProfile": [],
  "DNB.controller.locationController": [],
  "DNB.model.EventAudios": [],
  "DNB.model.EventCategory": [],
  "DNB.model.EventGallery": [],
  "DNB.model.EventPayStatus": [],
  "DNB.model.EventTime": [],
  "DNB.model.EventVideos": [],
  "DNB.model.FavouriteNotices": [],
  "DNB.model.FreeLocations": [],
  "DNB.model.NoticeComments": [],
  "DNB.model.NoticeMedia": [],
  "DNB.model.Notices": [],
  "DNB.model.Promotions": [],
  "DNB.store.EventAudiosStore": [],
  "DNB.store.EventCategoryMultiSelectStore": [],
  "DNB.store.EventCategorySearchStore": [],
  "DNB.store.EventCategoryStore": [],
  "DNB.store.EventGalleryStore": [],
  "DNB.store.EventVideosStore": [],
  "DNB.store.FavouriteNoticesStore": [],
  "DNB.store.FreeLocationsStore": [],
  "DNB.store.GalleryNoticesStore": [],
  "DNB.store.HotFiveNoticesStore": [],
  "DNB.store.MyNoticesStore": [],
  "DNB.store.NoticeCommentStore": [],
  "DNB.store.NoticeMediaStore": [],
  "DNB.store.NoticesSearchStore": [],
  "DNB.store.NoticesStore": [],
  "DNB.store.NotificationCategoryMultiSelectStore": [],
  "DNB.store.OtherNoticesStore": [],
  "DNB.store.PromotionsCategoryStore": [],
  "DNB.store.PromotionsStore": [],
  "DNB.util.Common": [],
  "DNB.util.Twitter": [],
  "DNB.view.About": [],
  "DNB.view.Account": [],
  "DNB.view.AddEvent": [],
  "DNB.view.AddPromotion": [],
  "DNB.view.Albums": [],
  "DNB.view.Calendar": [],
  "DNB.view.Category": [],
  "DNB.view.CategoryMultiSelect": [],
  ...
  "DNB.view.Home": [],
  "DNB.view.Login": [],
  "DNB.view.NoticeFreeLocations": [],
  "DNB.view.NotificationCategoryMultiSelect": [],
  "DNB.view.Promotion": [],
  "DNB.view.PromotionAudioPlayer": [],
  "DNB.view.ReSendLink": [],
  "DNB.view.Register": [],
  "DNB.view.Settings": [],
  "DNB.view.Splash": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "DNB.view.CategoryMultiSelect": [
    "widget.categorymultiselect"
  ],
  "DNB.view.CategoryOnSearch": [
    "widget.categoryonsearch"
  ],
  "DNB.view.ChangEmail": [
    "widget.changemail"
  ],
  ...
  "DNB.view.NoticeFreeLocations": [
    "widget.noticefreelocations"
  ],
  "DNB.view.NotificationCategoryMultiSelect": [
    "widget.notificationcategorymultiselect"
  ],
  "DNB.view.Promotion": [
    "widget.promotion"
  ],
  "DNB.view.PromotionAudioPlayer": [
    "widget.promotionaudioplayer"
  ],
  "DNB.view.ReSendLink": [
    "widget.resendlink"
  ],
